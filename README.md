...
- A component which dynamically generates curl commands to stop and start process groups and processors
...
* A functionality to generate curl commands for interacting directly with nifi through nifi-api. The commands generated primarily to stop processors, controller services, ports, process groups etc which are required before doing any modification on nifi slow   
